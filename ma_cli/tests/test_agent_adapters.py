...
class TestAgentConfig:
    ...
    def test_agent_config_defaults(self):
        ...
        config = AgentConfig(name="MinimalAgent", cli_command="minimal")
    ...
    def test_get_full_command(self):
        ...
        config = AgentConfig(
            name="TestAgent", cli_command="test", execute_args=["--run", "--verbose"]
        )
    ...
    def test_get_full_command_no_args(self):
        ...
        config = AgentConfig(name="SimpleAgent", cli_command="simple")
...
class TestCLIInfo:
    ...
    def test_cli_info_exists(self):
        ...
        info = CLIInfo(exists=True, path="/usr/bin/test-cli", version="1.0.0")
    ...
    def test_cli_info_not_exists(self):
        ...
        info = CLIInfo(exists=False, error="Command not found")
...
class TestAgentResult:
    ...
    def test_agent_result_success(self):
        ...
        result = AgentResult(success=True, stdout="Output here", exit_code=0, duration_ms=1500)
    ...
    def test_agent_result_failure(self):
        ...
        result = AgentResult(success=False, stderr="Error occurred", exit_code=1, duration_ms=500)
    ...
    def test_agent_result_timeout(self):
        ...
        result = AgentResult(success=False, timed_out=True, duration_ms=300000)
    ...
    def test_to_execution_result_success(self):
        ...
        agent_result = AgentResult(
            success=True, stdout="Success output", duration_ms=2000, metadata={"key": "value"}
        )
    ...
    def test_to_execution_result_failure(self):
        ...
        agent_result = AgentResult(
            success=False, stderr="Something went wrong", exit_code=1, duration_ms=1000
        )
...
class TestExternalAgentBase:
        ...
        with patch("shutil.which", return_value="/usr/bin/test-cli"):
            with patch("subprocess.run") as mock_run:
                mock_run.return_value = MagicMock(
                    returncode=0, stdout="test-cli version 1.0.0", stderr=""
                )
    ...
    async def test_review_success(self, test_agent):
        ...
        with patch.object(test_agent, "execute") as mock_execute:
            mock_execute.return_value = ExecutionResult(success=True, output="Code looks good!")
...
async def test_agent_health_check_all():
    ...
    for _agent_id, health in results.items():
