...
class TestRetryPolicy:
    ...
    def test_get_delay_max(self):
        """Test max delay cap."""
        policy = RetryPolicy(backoff_type="exponential", initial_delay_ms=1000, max_delay_ms=5000)
...
class TestApprovalPolicy:
    ...
    def test_requires_approval_for_listed(self):
        ...
        policy = ApprovalPolicy(auto_approve=False, require_approval_for=["delete", "deploy"])
    ...
    def test_no_approval_when_empty_list(self):
        ...
        policy = ApprovalPolicy(auto_approve=False, require_approval_for=[])
