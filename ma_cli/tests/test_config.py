...
class TestConfigurationEngine:
    ...
    def test_save_and_load_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config = Config(
                ...
                providers={
                    "test": ProviderConfig(
                        type="openai-compatible", base_url="http://test.local/v1"
                    )
                },
            )
    ...
    def test_add_provider(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            new_provider = ProviderConfig(type="anthropic", enabled=True, api_key="test-key")
    ...
    def test_update_runtime(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            engine.update_runtime(sandbox_enabled=False, audit_logging=False)
