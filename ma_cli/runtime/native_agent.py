...
class NativeAgent(Agent):
    ...
    def __init__(self, workspace: str | None = None):
        ...
        self._current_result: ExecutionResult | None = None
    ...
    async def _execute_developer_step(
    ...
    async def _execute_tester_step(
        self, node: TaskNode, context: dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def _execute_reviewer_step(
        self, node: TaskNode, context: dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def _execute_architect_step(
        self, node: TaskNode, context: dict[str, Any]
    ) -> ExecutionResult:
