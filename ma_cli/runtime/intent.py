...
class IntentAnalyzer:
    ...
    COMPLEXITY_INDICATORS = {
        ...
        TaskComplexity.COMPLEX: ['complex', 'advanced', 'full', 'complete', 'end-to-end', 'pipeline']
    }
    ...
    def analyze(self, request: str, context: Optional[Dict[str, Any]] = None) -> Intent:
        """
        ...
        requires_planning = (
            primary_intent in [IntentType.COMPLEX, IntentType.CREATE, IntentType.MODIFY] or
            detected_complexity == TaskComplexity.COMPLEX or
            len(entities) > 1
        )
