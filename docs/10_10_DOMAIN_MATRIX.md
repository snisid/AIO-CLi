...
| MCP | PASS | PASS | PASS | PASS | PASS | PASS | PENDING LIVE | READY |
| Git | PASS | PASS | PASS | PASS | PASS | PASS | PENDING LIVE | READY |
| Browser | PASS | PASS | PASS | PASS | PASS | PASS | PENDING LIVE | READY |
...
| Upgrade / Rollback | PASS | PASS | PASS | PASS | PASS | PASS | PENDING WINDOWS LIVE | READY |
